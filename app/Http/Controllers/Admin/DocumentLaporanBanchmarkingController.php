...
class DocumentLaporanBanchmarkingController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.document-laporan-banchmarking.index', compact('units'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $data = [
                ...
                'unit_dokument_id' => $request->unit_id,
            ];
            ...
            if ($request->hasFile('file')) {
                ...
                $path = $file->storeAs('documents/laporan-banchmarking', $filename, 'public');
                $data['path'] = $path;
            }

            DocumentLaporanBanchmarking::create($data);

            return response()->json([
                'status' => true,
                'message' => 'Dokumen Laporan Benchmarking berhasil ditambahkan.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $document = DocumentLaporanBanchmarking::findOrFail($id);
            ...
            return response()->json([
                'status' => true,
                'message' => 'Dokumen Laporan Benchmarking berhasil diperbarui.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'status' => true,
                'message' => 'Dokumen Laporan Benchmarking berhasil dihapus.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
