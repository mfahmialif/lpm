...
class DocumentSpmiController extends Controller
{
    ...
    {
        return view('admin.document-spmi.index');
    }
    ...
    {
        $query = DocumentSpmi::query()->orderBy('created_at', 'desc');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('file')) {
                ...
                $path = $file->storeAs('documents/spmi', $filename, 'public');
                $data['path'] = $path;
            }

            DocumentSpmi::create($data);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $document = DocumentSpmi::findOrFail($id);
