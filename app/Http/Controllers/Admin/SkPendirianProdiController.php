...
class SkPendirianProdiController extends Controller
{
    /**
    ...
    {
        return view('admin.sk-pendirian-prodi.index');
    }
    ...
    {
        $query = SkPendirianProdi::orderBy('created_at', 'desc');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('file')) {
                ...
                $path = $file->storeAs('documents/sk-pendirian-prodi', $filename, 'public');
                $data['path'] = $path;
            }

            SkPendirianProdi::create($data);

            return response()->json([
                'status' => true,
                'message' => 'SK Pendirian Prodi berhasil ditambahkan.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $document = SkPendirianProdi::findOrFail($id);
            ...
            return response()->json([
                'status' => true,
                'message' => 'SK Pendirian Prodi berhasil diperbarui.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'status' => true,
                'message' => 'SK Pendirian Prodi berhasil dihapus.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
