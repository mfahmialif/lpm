...
use App\Models\DokumentImplementasiSpmiPddikti;
use App\Models\Prodi;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;
use Yajra\DataTables\Facades\DataTables;

class DokumentImplementasiSpmiPddiktiController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.dokument-implementasi-spmi-pddikti.index', compact('prodis'));
    }
    ...
    {
        $query = DokumentImplementasiSpmiPddikti::with('prodi')->orderBy('created_at', 'desc');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('file')) {
                ...
                $path = $file->storeAs('documents/implementasi-spmi-pddikti', $filename, 'public');
                $data['path'] = $path;
            }

            DokumentImplementasiSpmiPddikti::create($data);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $document = DokumentImplementasiSpmiPddikti::findOrFail($id);
