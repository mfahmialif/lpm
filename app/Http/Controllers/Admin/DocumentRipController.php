...
class DocumentRipController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.document-rip.index', compact('units', 'prodis'));
    }
    ...
    {
        $query = DocumentRip::with(['unit', 'prodi'])->orderBy('created_at', 'desc');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('file')) {
                ...
                $path = $file->storeAs('documents/rip', $filename, 'public');
                $data['path'] = $path;
            }

            DocumentRip::create($data);

            return response()->json([
                'status' => true,
                'message' => 'Dokumen RIP berhasil ditambahkan.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $document = DocumentRip::findOrFail($id);
            ...
            return response()->json([
                'status' => true,
                'message' => 'Dokumen RIP berhasil diperbarui.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'status' => true,
                'message' => 'Dokumen RIP berhasil dihapus.'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
