...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call(DosenSeeder1::class);
        $this->call(DosenSeeder2::class);
        $this->call(DosenSeeder3::class);
        $this->call(competensi1::class);
        $this->call(competensi2::class);
        $this->call(competensi3::class);
        $this->call(competensi4::class);
        $this->call(competensi5::class);
        $this->call(competensi6::class);
        $this->call(competensi7::class);
        $this->call(competensi8::class);
        $this->call(competensi9::class);
