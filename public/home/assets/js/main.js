        ...
        window.addEventListener("scroll", function () {
            ...
            if (footer) {
                ...
                const buttonBottomRelativeToViewport =
                    viewportHeight -
                    scrollToTopButton.getBoundingClientRect().bottom;
...
class DrawerMenu extends HTMLElement {
    ...
    toggle(event) {
        ...
        if (sibling) {
            ...
            const hasGrandmenu = sibling.querySelector(".header-grandmenu");
...
class FaqAccordion extends HTMLElement {
    ...
    connectedCallback() {
        ...
        if (this.firstBlock) {
            this.firstContent =
                this.firstBlock.querySelector(".accordion-content");
            this.firstBlock.classList.add("active");
            this.firstContent.style.maxHeight =
                this.firstContent.scrollHeight + "px";
        }
    }
    ...
    toggleHeight(event) {
        ...
        if (this.accBlock.classList.contains("active")) {
            this.accContent.style.maxHeight =
                this.accContent.scrollHeight + "px";
        } else {
...
class ProgressBar extends HTMLElement {
    ...
    animateItem(item, duration = 2000) {
        ...
        function update() {
            ...
            number.style.left = `calc(${current}% - ${
