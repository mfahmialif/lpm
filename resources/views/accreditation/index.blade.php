...
@section('content')
    ...
    <div class="multicolumn mt-100 section-padding">
        ...
        <div class="container">
            ...
            <div class="multicolumn-inner">
                <div class="row">
                    @foreach ($accreditation as $item)
                        <div class="col-lg-4 col-12 multi-col aos-init aos-animate" data-aos="fade-up">
                            <a class="multicolumn-card" href="{{ route('accreditation.detail', $item) }}" aria-label="View Service Details">
                                <div class="card-icon">
                                ...
                                <h2 class="heading text-28">{{ $item->name }}</h2>
                                ...
                                <ul class="text-lists list-unstyled">
                                    ...
                                    <li class="text-item text text-16 fw-500">
                                        ...
                                        File Requirements / Documents: {{ $item->requirements->count() }}
                                    </li>
                                </ul>
                            </a>
                        </div>
            ...
            {{ $accreditation->links('vendor.pagination.custom') }}
        </div>
    </div>
@endsection
