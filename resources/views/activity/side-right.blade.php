    ...
    <div class="sidebar-filter drawer-blog-sidebar">
        ...
        <aside class="blog-sidebar">
            <div class="sidebar-widget radius18" data-aos="fade-up">
                ...
                <form action="{{ route('activity.index') }}" class="form-blog-search">
            ...
            <div class="sidebar-widget radius18" data-aos="fade-up">
                <h2 class="sidebar-heading heading text-24">Unit</h2>
                <ul class="blog-categories list-unstyled">
                    @foreach ($unit as $item)
                        <li>
                            <a class="blog-category subheading subheading-bg text-18 fw-400 {{ request('unit') == $item->name ? 'active' : '' }}"
                                href="{{ route('activity.index', ['unit' => $item->name, 'search' => request('search')]) }}"
                            ...
                            <div class="card-blog-list">
                                ...
                                <div class="card-blog-content">
                                    ...
                                    <h2 class="card-blog-heading heading text-20">
                                        <a href="{{ route('activity.detail', ['slug' => $item->slug]) }}" class="heading text-20">
                                            {{ $item->title }}
                                        </a>
                                    </h2>
                                </div>
