...
@section('title', 'Activities - LPM UII Dalwa')
@section('content')
                    ...
                    <div class="blog-list-wrapper">
                        @foreach ($activity as $item)
                            <div class="card-blog-list" data-aos="fade-up">
                                ...
                                <div class="mb-2">Unit: {{ $item->unit->pluck('name')->implode(', ') }}</div>
                                <div class="card-blog-content">
                                    ...
                                    <h2 class="card-blog-heading heading text-32">
                                        <a href="{{ route('activity.detail', ['slug' => $item->slug]) }}"
                                    ...
                                    <div class="buttons">
                                        <a href="{{ route('activity.detail', ['slug' => $item->slug]) }}"
                                            class="button--cta" aria-label="See blog details">
                                            Read More
