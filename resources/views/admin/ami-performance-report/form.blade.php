...
<div class="mb-6">
    ...
    @if (@$mode == 'edit' && @$amiPerformanceReport->document)
        <div class="mb-2">
            <a href="{{ asset('storage/documents/ami-performance-report/' . $amiPerformanceReport->document) }}" target="_blank" class="btn btn-sm btn-info">
