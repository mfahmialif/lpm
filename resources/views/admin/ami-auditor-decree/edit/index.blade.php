...
<div class="mb-6">
    <div class="card h-100">
        ...
        <div class="card-body">
            <form action="{{ route('admin.ami-auditor-decree.update', ['amiAuditorDecree' => $amiAuditorDecree]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
...
<script>
    $(document).ready(function() {
        ...
        $('[name="prodi_unit_id"]').val(amiAuditorDecree.prodi_unit_id).trigger('change');
