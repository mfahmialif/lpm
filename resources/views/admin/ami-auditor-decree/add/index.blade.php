...
@section('title', 'Add | SK Auditor AMI')
@section('content')
    <div class="mb-6">
        <div class="card h-100">
            <div class="card-header d-flex justify-content-between">
                <div class="card-title mb-0">
                    <h5 class="mb-1">Form Add SK Auditor AMI</h5>
                    <p class="card-subtitle">Please fill out all the required fields below to add a new auditor decree.</p>
                </div>
                <div class="dropdown">
            ...
            <div class="card-body">
                <form action="{{ route('admin.ami-auditor-decree.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
