...
@section('title', 'Add | Evaluasi Diri AMI')
@section('content')
    <div class="mb-6">
        <div class="card h-100">
            <div class="card-header d-flex justify-content-between">
                <div class="card-title mb-0">
                    <h5 class="mb-1">Form Add Evaluasi Diri AMI</h5>
            ...
            <div class="card-body">
                <form action="{{ route('admin.ami-self-evaluation.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @include('admin.ami-self-evaluation.form')
                </form>
            </div>
        </div>
    </div>
