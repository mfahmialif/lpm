...
<div class="mb-6">
    ...
    <textarea class="form-control" name="evaluations" rows="4" placeholder="Type here...">{{ old('evaluations') }}</textarea>
</div>
<div class="mb-6">
    <label class="form-label">Panduan Pengisian</label>
    <textarea class="form-control" name="filling_guide_name" rows="4" placeholder="Type here...">{{ old('filling_guide_name') }}</textarea>
</div>
<div class="mb-6">
    <label class="form-label">Dokumen</label>
    @if (@$mode == 'edit' && @$amiSelfEvaluation->document)
        <div class="mb-2">
            <a href="{{ asset('storage/documents/ami-self-evaluation/' . $amiSelfEvaluation->document) }}" target="_blank" class="btn btn-sm btn-info">
