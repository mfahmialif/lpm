<div class="col-sm-12">
    <label class="form-label" for="unit_dokument_id">Unit</label>
    <select class="form-select unit-select" name="unit_dokument_id">
...
<!-- <div class="col-sm-12 prodi-container" style="display: none;">
