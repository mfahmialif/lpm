...
@section('title', 'Add | RTM')
@section('content')
    <div class="mb-6">
        <div class="card h-100">
            <div class="card-header d-flex justify-content-between">
                <div class="card-title mb-0">
                    <h5 class="mb-1">Form Add RTM AMI</h5>
            ...
            <div class="card-body">
                <form action="{{ route('admin.ami-rtm.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @include('admin.ami-rtm.form')
                </form>
            </div>
        </div>
    </div>
