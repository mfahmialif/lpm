...
@section('title', 'RTM AMI')
@section('content')
    <div class="card" id="card-ami-rtm">
...
@push('scripts')
    <script>
        $(document).on('click', '#new-record-button', function() {
            location.href = "{{ route('admin.ami-rtm.add') }}";
        });
        ...
        var dataTable = initDataTables('table-1', 'loader-ami-rtm', 'card-ami-rtm', 'new-record-button', false,
            'RTM AMI', "{{ route('admin.ami-rtm.data') }}",
            [
                { data: "ami_period", name: "ami_period", className: "align-middle" },
                { data: "prodi_name", name: "prodi_name", className: "align-middle" },
                { data: "lead_auditor", name: "lead_auditor", className: "align-middle" },
