<div class="col-sm-12">
    <label class="form-label" for="unit_dokument_id">Unit (Prodi) <span class="text-danger">*</span></label>
    <select class="form-select" name="unit_dokument_id" aria-label="Unit Dokumen" required>
