...
@section('content')
    ...
    <div class="offcanvas offcanvas-end" id="new-record">
        ...
        <div class="offcanvas-body flex-grow-1">
            <form class="record pt-0 row g-2" id="form-new-record" action="{{ route('admin.category.store') }}"
                method="POST">
                @csrf
    ...
    <div class="offcanvas offcanvas-end" id="edit-record">
        ...
        <div class="offcanvas-body flex-grow-1">
            <form class="record pt-0 row g-2" id="form-edit-record" action="{{ route('admin.category.update') }}"
                method="POST">
                @csrf
                @method('PUT')
...
@push('scripts')
    ...
    <script>
        var dataTable = initDataTables('table-1', 'loader-category', 'card-category', 'new-record-button', false,
            'Category', "{{ route('admin.category.data') }}",
            [{
                    data: "name",
                    name: "name",
