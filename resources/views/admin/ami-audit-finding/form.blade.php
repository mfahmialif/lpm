...
<div class="mb-6">
    ...
    @if (@$mode == 'edit' && @$amiAuditFinding->document)
        <div class="mb-2">
            <a href="{{ asset('storage/documents/ami-audit-finding/' . $amiAuditFinding->document) }}" target="_blank" class="btn btn-sm btn-info">
