...
@section('title', 'Daftar SK Auditor - Temuan Audit')
@section('content')
<style>
    .hover-card {
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold py-3 mb-0">
                <span class="text-muted fw-light">AMI /</span> Temuan Audit
            </h4>
            <p class="text-muted mb-0">Pilih SK Auditor untuk mengelola temuan audit.</p>
        </div>
    </div>
</div>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('admin.ami.temuan.list') }}" method="GET">
            <div class="row align-items-end g-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.ami.temuan.list') }}" class="btn btn-label-secondary w-100">
                            Reset
                        </a>
                    </div>
                </div>
        ...
        <div class="card h-100 hover-card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 border-top pt-3">
                    <div>
                        <small class="text-muted d-block mb-1">Temuan</small>
                        <h6 class="mb-0 text-primary">{{ $sk->temuan_audits_count ?? 0 }} Data</h6>
                    </div>
                    <a href="{{ route('admin.ami.temuan.index', $sk->id) }}" class="btn btn-sm btn-primary">
