...
<div class="mb-6">
    <div class="card h-100">
        ...
        <div class="card-body">
            <form action="{{ route('admin.ami-assignment-letter.update', ['amiAssignmentLetter' => $amiAssignmentLetter]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
...
<script>
    $(document).ready(function() {
        ...
        $('[name="prodi_unit_id"]').val(amiAssignmentLetter.prodi_unit_id).trigger('change');
