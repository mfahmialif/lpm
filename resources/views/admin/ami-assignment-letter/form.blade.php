...
<div class="mb-6">
    ...
    <input type="date" class="form-control" name="assignment_date" value="{{ old('assignment_date') }}" />
</div>
<div class="mb-6">
...
<div class="mb-6">
    ...
    @if (@$mode == 'edit' && @$amiAssignmentLetter->document)
        <div class="mb-2">
            <a href="{{ asset('storage/documents/ami-assignment-letter/' . $amiAssignmentLetter->document) }}" target="_blank" class="btn btn-sm btn-info">
