...
<script>
    $(document).ready(function() {
        ...
        $('#form-indicator').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("admin.ami-self-assessment.storeIndicator", $amiSelfAssessment->id) }}',
        ...
        $('#form-score').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ url("admin/ami-self-assessment/indikator/score") }}/' + indicatorId,
        ...
        $(document).on('click', '.btn-delete-score', function() {
            ...
            Swal.fire({
                ...
                preConfirm: function() {
                    return $.ajax({
                        type: 'DELETE',
                        url: '{{ url("admin/ami-self-assessment/indikator/score") }}/' + scoreId,
