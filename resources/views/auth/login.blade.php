...
<head>
    ...
    <title>{{ config('app.name', 'Dalwa') }}</title>
    <link href="{{ asset('loggedin') }}/css/bootstrap.min.css" rel="stylesheet">
    <link href="{{ asset('loggedin') }}/css/common.css" rel="stylesheet">


    <link href="https://fonts.googleapis.com/css?family=Poppins:400,600,700&display=swap" rel="stylesheet">
    <link href="{{ asset('loggedin') }}/css/theme-03.css" rel="stylesheet">
...
<body>
        ...
        <div class="forny-inner">
            <div class="forny-form">
                <div class="mb-8 text-center forny-logo">
                    <img src="{{ asset('loggedin') }}/img/logo.png">
                </div>
                @if ($errors->any())
                ...
                <form action="{{ route('login') }}" method="POST" onsubmit="disableSubmit(this)">
                    @csrf
    ...
    <script src="{{ asset('loggedin') }}/js/jquery.min.js"></script>
    <script src="{{ asset('loggedin') }}/js/bootstrap.min.js"></script>
    <script src="{{ asset('loggedin') }}/js/main.js"></script>
    <script src="{{ asset('loggedin') }}/js/demo.js"></script>
